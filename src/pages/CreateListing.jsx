   ...
   <main className="max-w-md px-2 mx-auto">
    ...
    <form onSubmit={onSubmit}>
        ...
        <div className="flex mb-6">
         ...
         {/* Images close */}
         <button type="submit"
         className="w-full bg-blue-600 py-3 px-7 mb-6 font-medium text-white text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-blue-800  active:shadow-lg transition duration-150 ease-in-out ">Create Listing</button>
    </form>
   </main>
  )
}
