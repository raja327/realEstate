...
export default function Listing() {
  ...
  return (
    ...
    onClick={()=>
    {
      ...
      <div className="flex m-4 flex-col md:flex-row max-w-6xl lg:mx-auto p-4 rounded-lg shadow-lg bg-white lg:space-x-5">
          ...
          <p className='text-2xl font-bold mb-3 text-blue-900 '>{listing.name}- ${listing.offer ? listing.discountedPrice.toString()
              ...
              <ul className='flex items-center space-x-2 lg:space-x-10 text-sm font-semibold mb-6'>
                <li className='flex items-center whitespace-nowrap'>
                  <FaBed className='text-lg mr-1'/>{+listing.bedrooms >1 ? `${listing.bedrooms}Beds`:"1 Bed" }</li>

                  <li className='flex items-center whitespace-nowrap'>
                  <FaBath className='text-lg mr-1'/>{+listing.bathrooms >1 ? `${listing.bathrooms}Baths`:"1 Bath" }</li>
        ...
        <div className="bg-blue-300 w-full h-[200px] lg:h-[400px] z-10 overflow-x-hidden mt-6 lg:mt-0 md:ml-2">
          
{/* map using react leaflet giving latitude and longitude manually */}
